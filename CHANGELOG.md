...
- When providing alias `GITLEAKS_CONFIGURATION_FILE` environment variable, actually export the resulting `GITLEAKS_CONFIG` env var, restoring backwards compatibility for HMPPS consumers
